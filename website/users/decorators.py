# Slightly adapted from https://stackoverflow.com/questions/2723842/django-message-framework-and-login-required
...
default_message = "Please log in first to see the page you requested."
